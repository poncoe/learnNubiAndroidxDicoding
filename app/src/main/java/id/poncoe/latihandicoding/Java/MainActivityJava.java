package id.poncoe.latihandicoding.Java;
...
import id.poncoe.latihandicoding.Java.recyclerview.MainRecyclerView;
import id.poncoe.latihandicoding.Kotlin.BarVolumeKt;
import id.poncoe.latihandicoding.Kotlin.ViewViewGroupKt;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_kt_3:
                ...
                break;
            case R.id.btn_kt_4:
                Intent kt4 = new Intent(MainActivityJava.this, id.poncoe.latihandicoding.Kotlin.recyclerview.MainRecyclerView.class);
                startActivity(kt4);
                break;
        }
    }
